...
31 tools across seven surfaces:
...
- `otwa_list_iso_library` — bootable custom ISOs (deploy with `os: "custom-iso"`)
...
- `otwa_create_snapshot` — capture a disk snapshot, max 2/server *(servers:write)*
